...
plot_household <- 
  ...
  labs(
    title = "TITLE",
    subtitle = "Subtitle",
    caption = "Author: John Cena \n Contact: johncena@rocketmail.id \n Data source: The World Bank, 2019",
    x = "Electricity Total (Gwh)",
    y = "safe Sanitation (Billions Dollar)",
    colour = "Year",
    size = "Safe Water (Billions Dollar)"
  )
plot_household
```
...
berkas logo menjadi “../data-raw/telkom-university.png”\!
